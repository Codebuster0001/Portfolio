...
export default function StatCard({ title, count, icon: Icon, subtext, color = 'blue', index = 0 }) {
  ...
  return (
    <motion.div
      ...
      className={`relative overflow-hidden rounded-2xl bg-zinc-900/50 backdrop-blur-sm border ${bgClasses.split(' ')[2]} p-6 group hover:bg-zinc-900/80 transition-colors shadow-lg ${bgClasses.split(' ')[4]}`}
    >
      ...
      <div className="relative z-10 flex justify-between items-start">
        ...
        <div className={`p-3 rounded-xl bg-zinc-950/50 border ${bgClasses.split(' ')[2]}`}>
